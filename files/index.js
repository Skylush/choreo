...
const UUID = process.env.UUID || '986e0d08-b275-4dd3-9e75-36fa2af3094b'; //若需要改UUID，需要在config.json里改为一致
const NEZHA_SERVER = process.env.NEZHA_SERVER || 'naza.luu.us.kg';     
const NEZHA_PORT = process.env.NEZHA_PORT || '443';                     // 哪吒端口为{443,8443,2096,2087,2083,2053}其中之一开启tls
const NEZHA_KEY = process.env.NEZHA_KEY || '7YPgrAGd04Of0RwnHO';   // 没用哪吒，把这个参数空着
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'choreo.akile.ggff.net';     // 建议使用token，argo端口8080，cf后台设置需对应,使用json需上传json和yml文件至files目录
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiNDQ2ZGNkZDYzMTNlY2QzMWZmN2I0ZjU5YjhjYTk1NWMiLCJ0IjoiNjQ1NDJmYTMtM2MyMi00NjAzLWE5OWEtZTkxNDY0NzQwY2ViIiwicyI6IlpUTXdabVV3TVdFdFl6ZzJOUzAwTnpOaExUZzBaR010WWpreVltUmlZelZtTVRrNSJ9';
const CFIP = process.env.CFIP || 'www.visa.com.tw';
const NAME = process.env.NAME || 'Choreoeu';
